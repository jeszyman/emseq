...
*TANGLE WARNING (2026-03-24):* The tangled .smk and .sh files have been edited directly and diverge from the org source. Before tangling, fix these in the org blocks:
1. L1136: mosdepth quantize bug — change ~${quant_levels/,/:}~ to ~${quant_levels//,/:}~ (global replace)
2. L773,885,952: hardcoded threads — replace with ~rule_threads("...")~ calls (see workflows/emseq.smk for the current wired version)
