...
elisp:(org-execute-named-block-anywhere "~/repos/org/maintenance.org" "git-update-my-org")

[[elisp:(org-babel-execute-src-block nil (org-babel-lob-get-info "git-workflow-up"))
][test]]
