...
parser$add_argument("--output_tsv", required = TRUE,
                    help = "Prefix path for tabular output (no extension)")
...
fwrite(plot_data, file = paste0(args$output_tsv, "_threshold_counts.tsv"), sep = "\t")
fwrite(medians,   file = paste0(args$output_tsv, "_medians.tsv"), sep = "\t")
#!/usr/bin/env Rscript
