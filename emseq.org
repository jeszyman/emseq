...
rule emseq_dedup_bwameth:
    ...
    output:
        bam = f"{data_dir}/analysis/emseq/bams/{{library_id}}.{{ref_name}}.bwa_meth.namesort.deduped.bam",
        index = f"{data_dir}/analysis/emseq/bams/{{library_id}}.{{ref_name}}.bwa_meth.namesort.deduped.bam.bai",
    shell:
        r"""
        rm -f {output.bam}.tmp.*.bam
        samtools view -h -f 0x2 {input.bam} \
